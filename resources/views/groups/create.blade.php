...
>
    @section('navigation-title', __('Crear Grupo'))
    ...
    <div style="min-height: 100vh; background: {{ $isDark ? 'linear-gradient(135deg, #0a2e2c 0%, #0f3d3a 100%)' : '#f9f9f9' }}; color: {{ $textPrimary }}; padding: 16px 20px 100px; margin-top: 3.75rem;">
