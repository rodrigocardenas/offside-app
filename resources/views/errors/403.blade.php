...
<head>
    ...
    <title>{{ __('messages.errors.403.title') }} - {{ config('app.name') }}</title>
...
<body>
    <div class="container">
        <div class="card">
            ...
            <!-- Mensaje principal -->
            <h1>{{ __('messages.errors.403.title') }}</h1>

            <p>
                {{ __('messages.errors.403.message') }}
                <br>{{ __('messages.errors.403.submessage') }}
            </p>
