...
<head>
    ...
    <!-- jQuery & Select2 Libraries (MUST be before other scripts) -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js" integrity="sha256-/xUj3OJU5yExlq6GSYGSHk7tPFijrQlT1zqqK5FfZjQ=" crossorigin="anonymous"></script>
