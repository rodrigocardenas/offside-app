...
return [
    ...
    'profile_section' => [
        ...
        'delete_account_warning' => 'Esta acción desactivará tu cuenta. No podrás iniciar sesión y tus datos serán ocultados.',
        'delete_account_confirm_label' => 'Para confirmar, escribe <strong>DELETE</strong> en el campo de abajo:',
        'delete_account_confirm_placeholder' => 'Escribe DELETE para confirmar',
        'delete_account_button' => 'Sí, eliminar mi cuenta',
        'delete_account_cancel' => 'Cancelar',
        'delete_account_step2_title' => '¿Estás absolutamente seguro?',
        'delete_account_step2_warning' => 'Esta es tu última oportunidad de cancelar. Una vez eliminada, tendrás que contactar a soporte para recuperar tu cuenta.',
        'delete_account_confirm_button' => 'Confirmar eliminación',
    ],
    'feedback' => [
